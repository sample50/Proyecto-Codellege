        function IniciarSesion(){
            ...
            //en caso de que todo esté bien
                ...
                //regresar propiedades al boton perfil de usuario
                    document.getElementById("TextoDelBoton").innerHTML="Alex03";
        ...
        $("#NombreDeUsuario").click(function(){
            ...
            $("#AlertasEnELUsuario").fadeOut(1000)
            $("#AlertasDeContrasena").fadeOut(1000)
        })
        ...
        function Perfil(){
            ...
            if (x==1){
                ...
                $("#BotonDeImg").fadeIn(100)
                document.getElementById("TextoDelBoton").innerHTML="Alex03"
                document.getElementById("TextoDelBoton").style.color="rgb(170, 125, 0)"
                document.getElementById("nav").style.borderBottom="none"
                document.getElementById("BotonDeUsuario").value="1"
            }
        }
        function CerrarSesion(){
            ...
            document.getElementById("Usuarioo").style.backgroundColor="rgb(237, 252, 110)"
            document.getElementById("Usuarioo").style.color="rgb(170, 125, 0)"
            document.getElementById("nav").style.borderBottom="none"
        ...
        function Usuarioo(){
            ...
            if (x==1){
                ...
                document.getElementById("Usuarioo").style.color="black"
                document.getElementById("nav").style.borderBottom="2px solid white"
            }
            else {
                $(".IniciarSesion").animate({
